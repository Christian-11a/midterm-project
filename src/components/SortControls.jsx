...
export default function SortControls({ onSortChange, currentSort, pageContext }) {
    
    const optionsToShow = ALL_SORT_OPTIONS.filter(option => {
        if (pageContext === 'home') {
            return !option.value.startsWith('date-');
        }
        return true;
    });
    ...
    return (
        <div className="flex justify-end mb-6">
            ...
            >
                {optionsToShow.map(option => ( // 🔑 Use the filtered list
