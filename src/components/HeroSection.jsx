  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 h-full flex items-center">
        <div className="text-white max-w-lg pl-8"> 
          ...
          <Link
            to="#find-spaces"
            className="inline-block px-8 py-3 bg-green-600 text-white rounded-full font-semibold shadow-md transition-colors duration-300 hover:bg-green-700 cursor-pointer"
            onClick={(e) => {
              e.preventDefault(); 
              document.getElementById('find-spaces')?.scrollIntoView({ behavior: 'smooth' });
            }}
          >
            Book Now
          </Link>
